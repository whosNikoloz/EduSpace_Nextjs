      ...
      <section className="py-20 dark:bg-black dark:text-white">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="font-bold tracki uppercase dark:text-blue-600">
              Pricing
            </span>
          ...
          <div className="flex flex-wrap items-stretch -mx-4 ">
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 price">
              <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                <div className="space-y-2">
                  <h4 className="text-2xl font-bold">Beginner</h4>
                  <span className="text-6xl font-bold">Free</span>
                </div>
                <p className="mt-3 leadi dark:text-white">
                ...
                <ul className="flex-1 mb-6 dark:text-white">
                  <li className="flex mb-2 space-x-2">
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      className="flex-shrink-0 w-6 h-6 dark:text-blue-600"
                    >
                      <path
                        fillRule="evenodd"
                ...
                <button
                  type="button"
                  className="inline-block px-5 py-3 font-semibold tracki text-center rounded dark:bg-blue-600 dark:text-white"
                >
                  Get Started
                </button>
              </div>
            </div>
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 dark:text-white price">
              <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-blue-600 dark:text-white">
                <div className="space-y-2">
            ...
            <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 price">
              <div className="p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                ...
                <p className="leadi dark:text-white">
