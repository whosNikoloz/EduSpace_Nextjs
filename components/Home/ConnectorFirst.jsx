...
export const ConnectorFirst = ({ text, color }) => {
  switch (color) {
    case "blue":
    ...
    <div className="flex flex-col items-center">
      <div className="w-2/6 md:w-1/2 lg:w-4/6 relative">
        <Reveal direction="down" once={true}>
          <div className={`h-10 md:h-36 lg:h-56 ${color} border-l-4 w-full `}>
      ...
      <div className="w-2/6 md:w-1/2 lg:w-4/6">
        <Reveal direction="down" once={true}>
          <div
            className={`h-10 md:h-36 lg:h-56 ${color}  border-r-4 w-full`}
          ></div>
        </Reveal>
      </div>
    </div>
