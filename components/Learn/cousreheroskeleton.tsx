...
function CourseHeroSkeleton() {
  return (
    <>
      <Card
        isBlurred
        className="border-none bg-white dark:bg-gray-800 w-80 md:max-w-[610px] md:w-full"
        shadow="sm"
      >
        <CardBody>
          <div role="status" className="flex flex-col gap-2 md:flex-row">
            ...
            <div className="w-full animate-pulse md:py-10">
